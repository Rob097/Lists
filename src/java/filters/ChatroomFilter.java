...
public class ChatroomFilter implements Filter {
            ...
            if(session != null){                
                ...
                if(user != null && shopListName != null){
                    try {
                        ...
                        System.out.println("CHATROOMFILTER ERROR");
                        Logger.getLogger(ChatroomFilter.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }else {
    ...
    public String toString() {
        ...
        StringBuilder sb = new StringBuilder("ChatroomFilter(");
